...
% \begin{figure}
%     \includegraphics{graph-tutorial}
% \end{figure}
\todo{Create annotated graph with Balsamiq or similar}
...
Latencies observed in the same test case is given in \autoref{fig:vanilla-3p-latency}.
