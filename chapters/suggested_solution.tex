...
\centering
    \digraph{nodesplittingpost}{
        edge [dir=none];
        rankdir=LR;
        aprivate [label="A private"];
        apublic [label="A public"];
        bprivate [label="B private"];
        bpublic [label="B public"];

        aprivate -> apublic [label="0/5Mbit"];
        apublic -> aprivate [label="0/20Mbit"];

        apublic -> bpublic [label="8ms"];
        bpublic -> apublic [label="7ms"];

        bprivate -> bpublic [label="0/15Mbit"];
        bpublic -> bprivate [label="0/30Mbit"];
    }
