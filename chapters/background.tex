...
\todo[inline]{Only do Continous Presence if the client has enough available bandwidth, ie $BW\_{down}>n*BW\_{min}$, otherwise fall back to \gls{vas} through an \gls{mcu}}
