...
sudo tcpdump -i $iface -nNqtts68 "port not 3271 and port not 17500 and port not 137 and port not 138 and port not 1900 and (udp or tcp)" -w /tmp/$session_id.pcap 2> /dev/null &
tcpdump_pid=$!
